...
class bandwidth_manager {
  ...
  public:
	...
	_call.ip(" link set dev imq0 txqueuelen 5000 ");
	_call.ip(" link set dev imq1 txqueuelen 5000 ");



	_call.tc(OBOQ + "0 root handle 1: htb r2q 10 default 6");
	...
	/* Download */
	_call.tc(OBOQ + "1 root handle 1: htb r2q 10 default 6");
